function [beta_vals] = HWK_07_Problem_2_Benson(poly_deg, x_vals_data, y_vals_data)
% David Cortes
% March 30, 2026
%
% HWK_07_Problem_2_Benson
%
% Fits a polynomial of degree poly_deg to Benson's data using
...
%
% USAGE:
%   [beta_vals] = HWK_07_Problem_2_Benson(poly_deg, x_vals_data, y_vals_data)
%
% INPUTS:
...
% TEST CASES:
%
%   Test 1: Using Benson's data
%     load('Benson_data.mat');
%     [beta_vals] = HWK_07_Problem_2_Benson(poly_deg, x_vals_data, y_vals_data)
%
%   Test 2: Known linear data (degree 1, R^2 should equal 1)
%     x = [1; 2; 3; 4; 5];
%     y = [3; 5; 7; 9; 11];
%     [beta_vals] = HWK_07_Problem_2_Benson(1, x, y)
%     % Expected: beta_0 = 1, beta_1 = 2, R^2 = 1.0
    ...
    xlabel('x');
    ylabel('y');
    title(sprintf('Benson Data: Degree %d Fit, R^2 = %.6f', ...
           poly_deg, R_sq));
    ...
    % ================================================================
    fprintf('\n--- Benson Data: Least-Squares Polynomial Fit ---\n');
